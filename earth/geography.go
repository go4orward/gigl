...
func GetXYZFromLonLat(lon_in_degree float32, lat_in_degree float32, radius float32) *g3d.V3d {
...
func GetXYZFromLL(lon_in_radian float32, lat_in_radian float32, radius float32) *g3d.V3d {
